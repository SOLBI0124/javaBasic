...
public class ConditionalStatement {
	...
	public static void main(String[] args) {
		...
		if( regNo == 1 ){
				...
				gender ="남자";
		}else if(regNo==4){		//if 블럭 뒤에 else if ( ) { } 로 조건을추가할 수 있다.
				gender="여자";
			...
			//수행할 내용이 동일한 경우 논리연산자를 사용해 조건식을 결합 할 수 있다.
			if(regNo ==1 || regNo ==3){
				gender ="남자"; 
			}else if(regNo == 2 || regNo ==4)			
				gender="여자";										//수행할 내용이 한문장일 경우 블럭{ }생략가능
			else
				gender="확인불가";
			System.out.println("당신의 성별은 " + gender + " 입니다.") ;
			
			
			//성적에 등급을 부여하는 프로그래을 만들어보자.
			int score =88;
			String grade = null;
		...
		/*	
		    ...
		    switch(input1){
		    case 0 : System.out.println("0입니다."); break;
		...
		/*	
			...
			*/
		    ...
		    //문제3. 점수 3개를 입력받아 총점, 평균(둘째자리 반올림), 등급을 출력해주세요.
			Scanner s = new Scanner(System.in);
			...
			double avg = (int)(sum/3.0*10+0.5);				//평균
