...
public class Exam05 {
	...
	/*0     [5-1] 다음은 배열을 선언하거나 초기화한 것이다. 잘못된 것을 고르고 그 이유를 설명
	      하시오.d,e
	      
	      a. int[] arr[];
	      b. int[] arr = {1,2,3,};				//선언과 초기화 동시에 해야함o.따로 불가
	      c. int[] arr = new int[5];
	      d. int[] arr = new int[5]{1,2,3,4,5};	//{}안에 데이터개수가 있기때문에 []안에 크기 지정불가
	      											크기지정해주거나 중괄호에 값넣거나 둘중하나
	      e. int arr[5];						//배열 선언할때 크기지정X
	      f. int[] arr[] = new int[3][];
	...
	/*0      [5-2] 다음과 같은 배열이 있을 때, arr[3].length의 값은 얼마인가? 2
	...
	/*0      [5-3] 배열 arr에 담긴 모든 값을 더하는 프로그램을 완성하시오.
	      ...
	      class Exercise5_3
	      {
	         public static void main(String[] args)
	         {
	            ...
	            // 답 : for( int i = 0; i<arr.length; i++){
						sum += arr[i];						//배열 arr[i]에 담긴 모든 값을 더하는
							}
	...
	/*0      [5-4] 2차원 배열 arr에 담긴 모든 값의 총합과 평균을 구하는 프로그램을 완성하시오.
	...
	/*0      [5-6] 다음은 거스름돈을 몇 개의 동전으로 지불할 수 있는지를 계산하는 문제이다. 변
	...
	/*0      [5-8] 다음은 배열 answer에 담긴 데이터를 읽고 각 숫자의 개수를 세어서 개수만큼 ‘*’
	      ...
	      class Exercise5_8 {
	         public static void main(String[] args) {
	            ...
	            for (int i = 0; i < answer.length; i++) {
	                (1) 알맞은 코드를 넣어 완성하시오. }
	                //답 :counter[answer[i]-1] += 1;
	                
	                
	            for (int i = 0; i < counter.length; i++) {
	               
	                (2) 알맞은 코드를 넣어 완성하시오.
	                //답 :  System.out.print(counter[i]);
	...
	/*0      [5-10] 다음은 알파벳과 숫자를 아래에 주어진 암호표로 암호화하는 프로그램이다.
	...
	/*0     [5-12] 예제5-23을 변경하여, 아래와 같은 결과가 나오도록 하시오.
	 * 
	...
	/*0      [5-13] 단어의 글자위치를 섞어서 보여주고 원래의 단어를 맞추는 예제이다. 실행결과와
