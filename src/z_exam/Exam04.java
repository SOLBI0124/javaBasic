/*      [4-1] 다음의 문장들을 조건식으로 표현하라.
      ...
      6. int 형 변수 year가 400으로 나눠떨어지거나 또는 4로 나눠떨어지고
      100으로 나눠떨어지지 않을 때 true인 조건식
      year%400==0 || year%==0 && year%100 !=0
      
      7. boolean형 변수 powerOn가 flase일 때 true인 조건식
      powerOn == flase
      !powerOn
...
/*      [4-7] Math.random()을 이용해서 1부터 6사이의 임의의 정수를 변수 value에 저장하는
     ...
     답 : int answer = (int)(Math.random()*6)+1;
...
/*      [4-11] 피보나치(Fibonnaci) 수열(數列 ) 은 앞을 두 수를 더해서 다음 수를 만들어 나가   
      ...
      1과 2를 더해서 이 되어서 1,1,2,3,5,8,13,21,...과 같은 식으로 진행된다. 1과 1부터
...
/*      [4-14] 다음은 숫자맞추기 게임을 작성한 것이다. 1과 100사이의 값을 반복적으로 입력  
      ...
      class Exercise4_14
      {
         public static void main(String[] args)
         {
            ...
            int answer =     (1) ;                  //정답:(int)(Math.random()*100)+1;
