		...
		// TODO Auto-generated method stub
	      ...
	      class Exercise3_1 {
	         public static void main(String[] args) {
	            ...
	            System.out.println(1 + x << 33);									비트연산자 쉬프트/ 3(011)을 왼쪽으로 33(32bit+1)(1)번이동=110을 10진수로 바꾸면 6
	            System.out.println(y >= 5 || x < 0 && x > 2);		  &&먼저 true
	            System.out.println(y += 10  -  x++);								y+10 -  x(2) = 13  /x++=3							
	            System.out.println(x+=2);												x=x+2 -> x=5
	            System.out.println( !('A' <= c && c <='Z') );				!true=false
	            System.out.println('C'-c);												67-65=2
	            System.out.println('5'-'0');												5
	            System.out.println(c+1);													65+1=66 (char가 int로 형변환)
	            System.out.println(++c);													c=1+65 //66(B)
	            System.out.println(c++);													c=66(B)  /c=66+1 
	            System.out.println(c);														c=67  //C
	         }
	      }
	      */
	      ...
	      가 필요할 것이다. (1)에 알맞은 코드를 넣으시오.   //답:numOfApples/sizeOfBucket+1
	      ...
	      class Exercise3_2 {
	         public static void main(String[] args) {
	            ...
	            ln("필요한 바구니의 수 :"+numOfBucket);             //numOfApples % sizeofbuckt == 0 ? numOfApples/sizeOfBucket :  numOfApples/sizeOfBucket +1
	            System.out.print 																// numOfApples / sizeOfBucket + ((numOfApples % sizeOfBucket ==0 ) ? 0 : 1)
	         }
	      }
	      [실행결과] 
	      13
	      */
	      ...
	      class Exercise3_3 {
	         public static void main(String[] args) {
	            int num = 10;
	            System.out.println(  (1)  );               //답:  String res = num >0 ? "양수" : (num<0?  "음수" : "0")
	      ...
	      */
	      ...
	      class Exercise3_6 {
	         public static void main(String[] args) {
	            int num = 24;
	            System.out.println(  (1)  );											//답:(((num/10+1)*10)%num)
	            																										10-(num%10)
	         }
	      }
	      ...
	      */
	      ...
	      /*[3-7] 아래는 화씨(Fahrenheit)를 섭씨(Celcius)로 변환하는 코드이다. 변환공식이 'C = 5/9 ×(F - 32)'라고 할 때,
	      ...
	      class Exercise3_7 {
	         public static void main(String[] args) {
	            int fahrenheit = 100;
	            float celcius = (  (1)  );																				//답:   (   (int) (5/9f * (fahrenheit-32) * 100 + 0.5 ) / 100f   )
...
/*		[3-8] 아래 코드의 문제점을 수정해서 실행결과와 같은 결과를 얻도록 하시오.
		...
		class Exercise3_8 {
			public static void main(String[] args) { 
				byte a = 10; 
				byte b = 20; 
				byte c = a + b;          //답:byte c = (byte)(a + b);  형변환byte->int     or   int c = a + b ;
		
				char ch = 'A'; 
				ch = ch + 2;             //답: ch = (char)(ch + 2);
		
				float f = 3 / 2;        // 답: float f = 3 / 2f;
				long l = 3000 * 3000 * 3000;           				//답:long l = 3000 * 3000 * 3000l;
		
				float f2 = 0.1f; 
				double d = 0.1;                 								  // 답:double d = (float)0.1;         double을 float으로 형변환해야 정확하게 비교가능
	...
	*/
		...
		class Exercise3_9 {
			public static void main(String[] args) { 
				char ch = 'z';
				boolean b = (  (1)   );											// 답:('a'<=ch && ch<='z' || 'A'<=ch&&ch<='Z'||'0'<=ch&&ch<='9');
		...
		/* [3-10] 다음은 대문자를 소문자로 변경하는 코드인데 문자 ch에 저장된 문자가 대문자인 경우에만 소문자로 변경한다 
			...
			class Exercise3_10 {
				public static void main(String[] args) { 
					...
					char lowerCase = (  (1)  ) ? (  (2)  ) : ch;                                       //답:  ('A'<= ch && ch<='Z') ? (char)(ch+32) : ch;
