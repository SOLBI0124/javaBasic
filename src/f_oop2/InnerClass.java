...
public class InnerClass {
	...
	public static void main(String[] args) {
		Outer.InstanceInner li = new Outer().new InstanceInner(); //밖의 클래스 먼저 인스턴스화->내부 클래스 인스턴스화
...
class Outer{
	...
	class InstanceInner{
		...
		void method(){
			...
			System.out.println(Outer.this.var); //클래스명.this.변수 
		}
	}
...
//		int inner1 = instanceVar;	//인스턴스 변수는 사용 불가능
		int inner2 = classVar;
