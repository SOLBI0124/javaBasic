...
public class Variable {
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
	       ...
	       * 
	       * << 사용 가능한 기본형 데이터의 종류(괄호 숫자는 데이터 크기) >>
	       ...
	       * - [여러 단위로 이루어진 경우 단어의 첫 글자를 대문자로 한다.(상수는 언더바로 구분)]
	       * - [클래스명의 첫글자는 대문자로 한다.]
	       * - [패키지명은 모두 소문자로 한다.]
	       */
...
//	      System.out.println(_byte);//컴파일 에러 발생(문법이 틀렸다)
	      ...
	      _byte = 127; //타입에 맞는 값을 저장해야 한다.(byte는 -128에서 127까지 저장 가능)
	      _short = 30000;
	      _int = 20; //(20억까지)
	      _long = 900L; //long 접미사 : L(900경 까지)
	      ...
	      _byte = -128; //타입에 맞는 값을 저장해야 한다.(byte는 -128에서 127까지 저장 가능)
	      _short = -30000;
	      _int = -2147483648; //(20억까지)
	      _long = -900L; //long 접미사 : L(900경 까지)
	      _float = -3.14f; //float 접미사 : f
	      _double = -3.14; //double 접미사 : d(생략가능)
	      _char = '나';
	      ...
	      _String = "1234";//참조형 변수는 new를 이용해야하지만 String은 안해도됨
	      System.out.println(_String);
	      ...
	      //기본값 : 전역변수(메인 메서드 밖에 있는 변수,안에 있는 것은 지역변수)에 아무것도 저장하지 않았을때 저장되어 있는 값
	      _byte = 0;
	      _short = 0;
	      _int = 0;
	      _long = 0L;
	      ...
	      System.out.println(_byte); //128 -> -128(오버플로우, 한바퀴돌아서 나온숫자)
	      
	      _byte = -128;
	      _int = -129;
	      _byte = (byte)_int;
	      System.out.println(_byte); //-129 -> 1279언더플로우)
...
//	      System.out.println("입력받은 숫자 : " + input2);
	      ...
	      System.out.println("문자열과 숫자를 더한값 : " + input1 + input2);
